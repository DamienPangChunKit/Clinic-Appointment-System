...
public class AddAdmin extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private void validateRegister() {
        ...
        String imageInput = "https://firebasestorage.googleapis.com/v0/b/clinic-appointment-syste-9137d.appspot.com/o/images%2Fdoctor_icon.png?alt=media&token=9784ba08-8b38-4dd9-9ff0-9eba87dbdeca";
                        ...
                        .addOnCompleteListener(new OnCompleteListener<SignInMethodQueryResult>() {
                            ...
                            public void onComplete(@NonNull Task<SignInMethodQueryResult> task) {
                                ...
                                if (!checkEmail) {
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                                ...
                                                public void onComplete(@NonNull Task<AuthResult> task) {
                                                    if (task.isSuccessful()) {
                                                        User user = new User(usernameInput, genderInput, birthDateInput, phoneInput, emailInput, passwordInput, imageInput, addressInput, balance, userType, roleInput);
                                                        ...
                                                        FirebaseDatabase.getInstance().getReference()
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                if (task.isSuccessful()) {
                                                                    ...
                                                                    Toast.makeText(AddAdmin.this, "Register admin account successfully! Please verified your account before login!", Toast.LENGTH_SHORT).show();
                                                                    Intent i = new Intent(AddAdmin.this, Login.class);
                                                                    startActivity(i);
                                                                } else {
                                                                    Toast.makeText(AddAdmin.this, "Failed to register an admin account!", Toast.LENGTH_SHORT).show();
                                                                }
                                    ...
                                    Toast.makeText(AddAdmin.this, "Email has already been register before, please try a new Email!", Toast.LENGTH_SHORT).show();
                                    return;
                                }
                            }
                        });
    ...
    private void selectBirthDate() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(
                AddAdmin.this, new DatePickerDialog.OnDateSetListener() {
            @Override
